 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/accessWatchpointRequests/accwtchpreq002.
 ...
 *      Return an unmodifiable list of the enabled and disabled access watchpoint
 *      requests. This list is a live view of these requests and thus changes
 *      as requests are added and deleted.
 *      Returns: the all AccessWatchpointRequest objects.
 ...
 *     The debugger program - nsk.jdi.EventRequestManager.accessWatchpointRequests.accwtchpreq002;
 *     the debuggee program - nsk.jdi.EventRequestManager.accessWatchpointRequests.accwtchpreq002a.
