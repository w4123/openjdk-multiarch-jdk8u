 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/getProperty/getproperty001.
 ...
 *      Only properties added with putProperty(java.lang.Object, java.lang.Object)
 *      will return a non-null value.
 *      Returns: the value of this property or null
 *     The test checks up on following assertions:
 *       - a value of property is equal to one assigned with method putProperty(key, value);
 *       - the value of the property which is not assign with method putProperty(key, value),
 *         is the null.
 *     The cases to check include Requests of all sub-types.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequest.getProperty.getproperty001;
 *     the debuggee program - nsk.jdi.EventRequest.getProperty.getproperty001a.
