 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createMethodExitRequest/mexreg001.
 ...
 *      Returns: the created MethodExitRequest
 *     The test checks up on the following assertions:
 *     - Creates a new disabled MethodExitRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.createMethodExitRequest.mexreg001;
 *     the debuggee program - nsk.jdi.EventRequestManager.createMethodExitRequest.mexreg001a.
