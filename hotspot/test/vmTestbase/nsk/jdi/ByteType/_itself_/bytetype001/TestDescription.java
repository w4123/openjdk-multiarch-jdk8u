 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ByteType/_itself_/bytetype001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the implementation of an object of the type
 *     ByteType.
 *     The test checks that for a mirror of byte value the casts
 *     from Type to ByteType and from PrimitiveType to ByteType
 *     don't throw ClassCastException.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ByteType._itself_.bytetype001;
 *     the debuggee program - nsk.jdi.ByteType._itself_.bytetype001a.
