 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/declaringType/decltype005.
 ...
 *     nsk/jdi/TypeComponent/declaringType/declType005 checks assertions:
 ...
 *     override methods from super class; interfaces MainInter and SameInter that
 *     extends MainInter and do not override methods from it.
 *     Debugger gets each method from debuggee (SameClass and SameInter) calling
 *     by name and then checks if method declaringType() returns reference type
 *     where all methods were declared (MainClass and MainInter).
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
