 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachineManager/launchingConnectors/launching001.
 ...
 *     Any of the returned objects can be used to launch
 *     a new target VM and immediately create a VirtualMachine mirror for it.
 *     Returns: a list of LaunchingConnector objects.
