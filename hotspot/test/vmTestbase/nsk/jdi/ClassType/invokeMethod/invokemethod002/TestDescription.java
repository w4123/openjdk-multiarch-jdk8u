 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassType/invokeMethod/invokemethod002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test checks up that a result of the method
 *     com.sun.jdi.ClassType.invokeMethod()
 *     correctly works for the boundary parameter of the invoked method.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ClassType.invokeMethod.invokemethod002;
 *     The debuggee program - nsk.jdi.ClassType.invokeMethod.invokemethod002a.
 *     For every primitive value there is the simplest method on the debugee
 *     side, which has alone argument of this primitive value and returns
 *     the same value as argument. Such methods are invoked for boundary
