 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StepRequest/size/size002.
 ...
 *     The debugger program - nsk.jdi.StepRequest.size.size002;
 *     the debuggee program - nsk.jdi.StepRequest.size.size002a.
