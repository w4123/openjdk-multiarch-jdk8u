 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LocalVariable/isArgument/isargument001.
 ...
 *     Returns: true if this variable is argument; false otherwise.
 ...
 *     The debugger program - nsk.jdi.LocalVariable.isArgument.isargument001;
 *     the debuggee program - nsk.jdi.LocalVariable.isArgument.isargument001a.
 ...
 * @build nsk.jdi.LocalVariable.isArgument.isargument001
 *        nsk.jdi.LocalVariable.isArgument.isargument001a
 *
 * @comment make sure isargument001a is compiled with full debug info
