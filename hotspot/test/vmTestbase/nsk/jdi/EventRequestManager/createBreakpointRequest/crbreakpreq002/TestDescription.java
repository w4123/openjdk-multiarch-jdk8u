 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createBreakpointRequest/crbreakpreq002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.createBreakpointRequest()
 *     properly throws NullPointerException - if location is null.
 *
 * @library /vmTestbase
 *          /test/lib
