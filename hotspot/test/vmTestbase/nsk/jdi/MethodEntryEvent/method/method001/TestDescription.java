 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MethodEntryEvent/method/method001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *    The test exercises
 *        com.sun.jdi.event.MethodEntryEvent.method() method.
 *    The test checks the following assertions:
 *        - MethodEntryEvent is received by debugger for requested
 *          method if this method is invoked by some executing
 *          thread in debugged VM;
 *        - received MethodEntryEvent has proper references to:
 *            method,
 *            debugged VM,
 *            executed thread,
 *            related MethodEntryRequest.
 *        - MethodEntryEvent is produced before any code of the
 *          method is executed.
 *    A debugger class - nsk.jdi.MethodEntryEvent.method.method001  ;
 *    a debuggee class - nsk.jdi.MethodEntryEvent.method.method001a .
