 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/BooleanArgument/booleanValue/booleanvalue002.
 ...
 *     1) argument.setValue(true);
 *        argument.setValue("tru");
 *     2) argument.setValue(true);
 *        argument.setValue("");
 *     3) argument.setValue(false);
 *        argument.setValue("");
 *     4) argument.setValue(false);
 *        argument.setValue("fals");
 *     5) argument.setValue("true");
 *        argument.setValue("tru");
 *     6) argument.setValue("true");
 *        argument.setValue("");
 *     7) argument.setValue("false");
 *        argument.setValue("");
 *     8) argument.setValue("false");
 *        argument.setValue("fals");
