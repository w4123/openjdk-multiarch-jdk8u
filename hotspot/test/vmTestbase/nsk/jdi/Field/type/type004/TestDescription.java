 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Field/type/type004.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for type() method of Field interface.
 *  The test checks if the method returns correct result for
 *  each enum constant field declared in mirrored enum type.
 *  The test consists of a debugger program (type004.java)
 *  and debuggee application (type004a.java).
 *  Package name is nsk.jdi.Field.type .
 ...
 *  The debugger checks if each field is "self-typed", i.e.
