 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachineManager/listeningConnectors/listening001.
 ...
 *     Any of the returned objects can be used to listen for a connection
 *     initiated by a target VM and create a VirtualMachine mirror for it.
 *     Returns: a list of ListeningConnector objects.
