 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Locatable/location/location003.
 ...
 *     when it is applied to methods returning ReferenceType objects.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Locatable.location.location003;
 *     the debuggee program - nsk.jdi.Locatable.location.location003a.
