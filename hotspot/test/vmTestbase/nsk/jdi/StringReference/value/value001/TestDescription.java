 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StringReference/value/value001.
 ...
 *     Note. The test doesn't check up the following:
 *     Throws: ObjectCollectedException -
 *     if this object has been garbage collected.
 *     The test works as follows:
 *     A debugger program - nsk.jdi.StringReference.value.value001;
 *     a debuggee program - nsk.jdi.StringReference.value.value001a.
