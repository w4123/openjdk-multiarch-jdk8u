 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassType/superclass/superclass002.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for superclass() method of ClassType interface.
 *  The test checks if the method returns java.lang.Enum reference
 *  for any mirrored enum type
 *  The test consists of a debugger program (superclass002.java)
 *  and debuggee application (superclass002a.java).
 *  Package name is nsk.jdi.ClassType.superclass .
 ...
 *  the debugger calls superclass() method for each field
 *  of enum type declared in fields006a class.
 *  The test fails if the method returned type name other
 *  than "java.lang.Enum".
 * COMMENTS:
