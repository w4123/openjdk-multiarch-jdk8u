 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/version/version001.
 ...
 *     Returns the version of the Java Runtime Environment in the target VM as
 *     reported by the property java.version. For obtaining the JDI interface
 *     version, use VirtualMachineManager.majorInterfaceVersion() and
 *     VirtualMachineManager.minorInterfaceVersion()
 *     Returns: the target VM version.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.version.version001;
 *     the debuggee program - nsk.jdi.VirtualMachine.version.version001a.
