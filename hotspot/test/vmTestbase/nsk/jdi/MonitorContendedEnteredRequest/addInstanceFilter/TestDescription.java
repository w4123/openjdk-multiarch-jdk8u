 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MonitorContendedEnteredRequest/addInstanceFilter.
 * VM Testbase keywords: [quick, jpda, jdi, feature_jdk6_jpda, vm6]
 * VM Testbase readme:
 * DESCRIPTION
 *         The test checks up that a result of the method com.sun.jdi.MonitorContendedEnteredRequest.addInstanceFilter(ObjectReference instance)
