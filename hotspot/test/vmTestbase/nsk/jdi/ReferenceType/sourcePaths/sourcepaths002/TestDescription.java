 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/sourcePaths/sourcepaths002.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *        com.sun.jdi.ReferenceType.sourcePaths()
 *     properly throws AbsentInformationException - if the source paths are
 *     not known.
 ...
 *     to the declaration types of several debuggee fields, which are:
