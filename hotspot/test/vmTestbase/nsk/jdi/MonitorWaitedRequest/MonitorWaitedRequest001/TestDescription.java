 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MonitorWaitedRequest/MonitorWaitedRequest001.
 ...
 *         debuggee generate several thousands of MonitorWaitedEvents and checks that all events was received and contains
 *         correct information.
 ...
 *         This test set eventsNumber to 500 and threadsNumber to 1, but because of framework design generation of MonitorWait
