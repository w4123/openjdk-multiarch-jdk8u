 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/allLineLocations/alllinelocations001.
 ...
 *              there are non-native, non-abstract executable members of this class.
 *              ClassNotPreparedException -
 *              if this class not yet been prepared.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ReferenceType.allLineLocations.alllinelocations001;
 *     the debuggee program - nsk.jdi.ReferenceType.allLineLocations.alllinelocations001a.
 ...
 * @build nsk.jdi.ReferenceType.allLineLocations.alllinelocations001
 *        nsk.jdi.ReferenceType.allLineLocations.alllinelocations001a
 *
 * @comment make sure alllinelocations001a is compiled with full debug info
