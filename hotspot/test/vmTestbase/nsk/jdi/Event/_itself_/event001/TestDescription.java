 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Event/_itself_/event001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks up the JDI interface
 *     com.sun.jdi.event.Event.
 *     A debugger part
 *     of the test creates several AccessWatchpointRequests, and
 *     verifies that all appropriate events have been generated by a
 *     target VM. Then, the debugger removes one request via
 *     deleteEventRequest() call. Finally, the test checks that
 *     the event corresponding to the deleted request, are not generated.
 * COMMENTS
