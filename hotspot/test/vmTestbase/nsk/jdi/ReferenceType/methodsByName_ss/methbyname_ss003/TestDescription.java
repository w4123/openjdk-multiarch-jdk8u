 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/methodsByName_ss/methbyname_ss003 test
 *         checks the methodsByName(String name, String signature) method of
 *         ReferenceType interface of the com.sun.jdi package for UNLOADED class:
 *         the test loads a class, gets a ReferenceType instance for this
 *         class, then enforces the class to be unloaded and calls the
 *         methodsByName(String name, String signature) method - the
 *         com.sun.jdi.ObjectCollectedException should be thrown in this case.
 * COMMENTS
 ...
 *         - methodsByName_ss003b class was moved in 'loadclass' subdirectory;
 *         - package name was added in methodsByName_ss003b class;
 *         - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *         - ClassUnloader seekes for methodsByName_ss003b class in
 ...
 * @build nsk.jdi.ReferenceType.methodsByName_ss.methbyname_ss003
 *        nsk.jdi.ReferenceType.methodsByName_ss.methbyname_ss003a
 *
 ...
 *      "-debugee.vmkeys=${test.vm.opts} ${test.java.opts} -Djava.library.path=${java.library.path}" ./bin
 */
