 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Value/type/type002.
 ...
 *     an object of the VoidType.
 *     Note: The spec is missed.
 *     The test works as follows:
 *     A debugger program - nsk.jdi.Value.type.type002;
 *     a debuggee program - nsk.jdi.Value.type.type002a.
 ...
 * an object of a VoidType.                                     <BR>
 * <BR>
 * The case for testing is as follows.                  <BR>
 *                                                      <BR>
 * When a gebuggee is suspended at a breakpoint set up  <BR>
 * by a debugger, the debugger invokes debuggee's method<BR>
 *    void vdValue1(); to get Value returnvdValue1      <BR>
 *                                                      <BR>
 * Then it forms a Type object for returnvdValue1       <BR>
 *      Type typevdValue = returnvdValue1.type();       <BR>
 * and performs the following cast:                     <BR>
 *    VoidType voidtypevdValue = (VoidType) typevdValue;<BR>
 * which should not throw ClassCastException.           <BR>
 * <BR>
 */
...
public class type002 {
    ...
    private String testedClassName =
        "nsk.jdi.Value.type.type002.Threadtype002a";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                List<Method> invokeMethods  =  testedclass.methodsByName("vdValue1");
                Method invokeMethod = invokeMethods.get(0);

                List<Value> argumentList = Collections.<Value>emptyList();

                try {
                     log2("      invoking type002a.vdValue1()");
                ...
                log2("      Type typevdValue = returnvdValue1.type();");
                Type typevdValue = returnvdValue1.type();

                log2("      checking up cast");
                try {
                     log2("      VoidType voidtypevdValue = (VoidType) typevdValue; no Exception expected");
