 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ExceptionRequest/addInstanceFilter/instancefilter004.
 ...
 *     (2) For ExceptiontRequest1, both invocations are with the same
 *         ObjectReference restricting one Exception event to one object.
 *         The test expects this Exception event will be received
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ExceptionRequest.addInstanceFilter.instancefilter004;
 *     the debuggee program - nsk.jdi.ExceptionRequest.addInstanceFilter.instancefilter004a.
