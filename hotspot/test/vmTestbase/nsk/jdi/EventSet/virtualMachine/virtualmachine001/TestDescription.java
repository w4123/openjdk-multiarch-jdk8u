 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/virtualMachine/virtualmachine001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  The test for public virtualMachine() method of an implementing class of
 *  com.sun.jdi.EventSet interface. This method is inherited from
 *  com.sun.jdi.Mirror interface.
 *  The test checks an assertion :
 *     public VirtualMachine virtualMachine()
 *     Gets the VirtualMachine to which this Mirror belongs.
 *     A Mirror must be associated with a VirtualMachine to have any meaning.
 *       Returns:
 *             the VirtualMachine for which this mirror is a proxy.
 * COMMENTS:
 *  The test is aimed to increase jdi source code coverage and checks
 *  the code which was not yet covered by previous tests for EventSet
 ...
 *     - adjusting source line numbers for setting breakpoints
 *
 * @library /vmTestbase
 *          /test/lib
