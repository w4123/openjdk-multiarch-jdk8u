 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createStepRequest/crstepreq008.
 ...
 *       A sizevalue of StepRequest.STEP_MIN will generate a step event each time
 *       the code index changes. It represents the smallest step size available and
 *       often maps to the instruction level....
 *       A depth value of StepRequest.STEP_OVER restricts step events to the current
 *       frame or caller frames.
 *   The debugger class - nsk.jdi.EventRequestManager.createStepRequest.crstepreq008;
 *   the debuggee class - nsk.jdi.EventRequestManager.createStepRequest.crstepreq008a;
 ...
 *      with STEP_MIN size and STEP_OVER depth, resumes the debuggee and
