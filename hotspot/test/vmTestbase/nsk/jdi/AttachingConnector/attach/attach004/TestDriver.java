...
public class TestDriver {
    public static void main(String[] args) throws InterruptedException {
        ...
        Process debugger = startDebugger(jdiArgs, Arrays.copyOfRange(args, 3, args.length), getPid(debuggee));
    ...
    private static int getCurrentVMId() {
        try {
    ...
    private static Process startDebuggee(String[] jdiArgs, String transport, String suspend) {
        ...
        Collections.addAll(cmd, Utils.addTestJavaOpts(
                "-cp",
                Utils.TEST_CLASS_PATH + File.pathSeparator + System.getProperty("compile.jdk", ".") + "/lib/tools.jar",
                "-Djava.library.path=" + System.getProperty("test.nativepath", "."),
                "-Xdebug",
                "-agentlib:jdwp=transport=" + transport + ",server=y,suspend=" + suspend,
                "-Dmy.little.cookie=" + TestDriver.getCurrentVMId(),
