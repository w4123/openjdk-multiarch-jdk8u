 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/modificationWatchpointRequests/modwtchpreq002.
 ...
 *      Return an unmodifiable list of the enabled and disabled modificaton watchpoint
 *      requests. This list is a live view of these requests and thus changes
 *      as requests are added and deleted.
 *      Returns: the all ModificationWatchpointRequest objects.
 *     The test checks up on the following assertions:
 *       - The list is unmodifiable.
 *       - The list of the enabled and disabled modification watchpoint requests.
 *       - This list is changes as requests are added and deleted.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.modificationWatchpointRequests.modwtchpreq002;
 *     the debuggee program - nsk.jdi.EventRequestManager.modificationWatchpointRequests.modwtchpreq002a.
