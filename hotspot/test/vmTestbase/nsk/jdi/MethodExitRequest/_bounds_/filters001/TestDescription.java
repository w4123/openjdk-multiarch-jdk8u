 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MethodExitRequest/_bounds_/filters001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the methods
 *     com.sun.jdi.request.MethodExitRequest.addThreadFilter(ThreadReference)
 *     com.sun.jdi.request.MethodExitRequest.addInstanceFilter(ObjectReference)
 *     com.sun.jdi.request.MethodExitRequest.addClassFilter(ReferenceType)
 *     com.sun.jdi.request.MethodExitRequest.addClassFilter(String)
 *     com.sun.jdi.request.MethodExitRequest.addClassExclusionFilter(String)
