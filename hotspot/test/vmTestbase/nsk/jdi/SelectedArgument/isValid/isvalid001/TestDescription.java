 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/SelectedArgument/isValid/isvalid001.
 ...
 *     - To argument's List of choices, the above checks are applied.
 *     In case of any check returns a wrong value,
