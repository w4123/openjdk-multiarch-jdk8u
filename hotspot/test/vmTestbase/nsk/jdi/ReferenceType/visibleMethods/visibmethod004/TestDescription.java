 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/visibleMethods/visibmethod004.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/visibleMethods/visibmethod004 test
 *         checks the visibleMethods() method of ReferenceType interface
 *         of the com.sun.jdi package for class without visible methods:
 *        the ReferenceType.visibleMethods() method is checked for
