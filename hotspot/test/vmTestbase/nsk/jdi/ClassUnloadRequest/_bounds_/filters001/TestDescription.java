 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassUnloadRequest/_bounds_/filters001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the methods
 *     com.sun.jdi.request.ClassUnloadRequest.addClassFilter(String)
 *     com.sun.jdi.request.ClassUnloadRequest.addClassExclusionFilter(String)
 *     correctly work for the boundary value of parameter and throw described
 *     exceptions.
 *     The test check up these methods with <null> argument value. In any cases
