 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/dispose/dispose003.
 ...
 *     debuggee's tested thread suspended by the debugger with the method
 *     ThreadRefrence.suspend(), is resumed and runs.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.dispose.dispose003;
 *     the debuggee program - nsk.jdi.VirtualMachine.dispose.dispose003a.
