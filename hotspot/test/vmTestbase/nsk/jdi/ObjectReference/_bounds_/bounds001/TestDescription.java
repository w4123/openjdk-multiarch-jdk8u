 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/_bounds_/bounds001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test checks up the method com.sun.jdi.ObjectReference.invokeMethod()
 *     Test checks up that NullPointerException will be thrown in
 *     the following cases:
 *         - invokeMethod(null, method, params,ObjectReference.INVOKE_NONVIRTUAL)
 *         - invokeMethod(thread, null, params,ObjectReference.INVOKE_NONVIRTUAL)
 *         - invokeMethod(thread, method, null,ObjectReference.INVOKE_NONVIRTUAL)
 *     In case
