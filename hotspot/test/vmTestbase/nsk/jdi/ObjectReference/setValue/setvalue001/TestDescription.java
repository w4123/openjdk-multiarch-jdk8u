 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/setValue/setvalue001.
 ...
 *     that is, there must be a widening reference conversion from this object
 *     to the field's type. If static, the field must not be final.
 ...
 *     Primitive values must be either assignment compatible with the field type or
 *     must be convertible to the field type without loss of information.
 *     See the JavaTM Language Specification.section 5.2 for more information on
 ...
 *             if the value's type does not match the field's type.
 *             ClassNotLoadedException -
 *             if the field type has not yet been loaded through
 *             the appropriate class loader.
 *             ObjectCollectedException -
 *             if this object or the new value (if an ObjectReference) has been
 *             garbage collected.
 *             VMMismatchException -
 ...
 *     The debugger program - nsk.jdi.ObjectReference.setValue.setvalue 00;
 *     the debuggee program - nsk.jdi.ObjectReference.setValue.setvalue 00a.
