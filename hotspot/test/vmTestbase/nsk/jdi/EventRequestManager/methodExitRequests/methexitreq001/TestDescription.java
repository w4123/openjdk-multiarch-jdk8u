 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/methodExitRequests/methexitreq001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.methodExitRequests()
 *     properly returns all previously created MethodExitRequest objects when:
