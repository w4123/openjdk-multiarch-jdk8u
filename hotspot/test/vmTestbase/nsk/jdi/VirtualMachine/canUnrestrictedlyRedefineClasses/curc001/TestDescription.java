 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/canUnrestrictedlyRedefineClasses/curc001.
 ...
 *      Determines if the target VM supports unrestricted changes when
 *      performing class redefinition.
 *      Returns: true if the feature is supported, false otherwise.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.canUnrestrictedlyRedefineClasses.curc001;
 *     the debuggee program - nsk.jdi.VirtualMachine.canUnrestrictedlyRedefineClasses.curc001a.
