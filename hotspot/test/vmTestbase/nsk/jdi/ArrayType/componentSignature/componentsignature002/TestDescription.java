 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ArrayType/componentSignature/componentsignature002.
 ...
 *     The signature describes the declared type of the components.
 *     If the components are objects, their actual type in
 *     a particular run-time context may be a subclass of the declared class.
 ...
 *     The debugger program - nsk.jdi.ArrayType.componentSignature.componentsignature002;
 *     the debuggee program - nsk.jdi.ArrayType.componentSignature.componentsignature002a.
