 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MonitorWaitRequest/addClassFilter_ClassName.
 * VM Testbase keywords: [quick, jpda, jdi, feature_jdk6_jpda, vm6]
 * VM Testbase readme:
 * DESCRIPTION
 *         The test checks up that a result of the method com.sun.jdi.MonitorWaitRequest.addClassFilter(String classPattern)
 ...
 *         Test also checks that received com.sun.jdi.MonitorWaitEvent complies with its spec and containc correct data.
 ...
 *      nsk.share.jdi.EventTestTemplates$ClassFilterTest_ClassName
 *      -verbose
