 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/defaultStratum/defaultstratum001.
 ...
 *     This value is specified in the class file and cannot be set by the user.
 *     If the class file does not specify a default stratum the base stratum
 *     ("Java") will be returned.
 *     See the Location for a description of strata.
 *     The case for testing includes only a class file with the base stratum.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ReferenceType.defaultStratum.defaultstratum001;
 *     the debuggee program - nsk.jdi.ReferenceType.defaultStratum.defaultstratum001a.
