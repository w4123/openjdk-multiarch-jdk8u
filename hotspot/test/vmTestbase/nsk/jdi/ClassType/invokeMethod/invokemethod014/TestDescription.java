 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassType/invokeMethod/invokemethod014.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *         com.sun.jdi.ClassType.invokeMethod()
 *     properly throws IllegalArgumentException when debugger part
 *     of the test attempts to invoke several debuggee methods:
 *      - which are constructors or static intializers;
 *      - which are instance ones.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
