 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/sourceName/sourcename002 test
 ...
 *         sourceName() method - the com.sun.jdi.ObjectCollectedException
 ...
 *           - sourcename002b class was moved in 'loadclass' subdirectory;
 *           - package name was added in sourcename002b class;
 *           - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *           - ClassUnloader seekes for sourcename002b class in
 ...
 * @build nsk.jdi.ReferenceType.sourceName.sourcename002
