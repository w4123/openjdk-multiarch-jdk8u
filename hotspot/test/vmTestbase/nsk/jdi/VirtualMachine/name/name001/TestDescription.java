 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/name/name001.
 ...
 *     The debugger program - nsk.jdi.VirtualMachine.name.name001;
 *     the debuggee program - nsk.jdi.VirtualMachine.name.name001a.
