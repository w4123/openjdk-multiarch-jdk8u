 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/redefineClasses/redefineclasses013.
 ...
 *     This test looks like redefineclasses005 and checks the assertion
 *     against interfaces.
 *     The test consists of the following files:
 *         redefineclasses013.java             - debugger
 *         redefineclasses013a.java            - debuggee
 *         redefineclasses013b.java            - an initial redefined class
 *         newclassXX/redefineclasses013b.java - redefining debuggee's class
 *     This test performs the following cases:
 *       1. newclass01 - adding new method declared as
 *                       "abstract public void newMethod()"
 *       2. newclass02 - adding new method declared as "public void newMethod()"
 *       3. newclass03 - adding new method declared as "void newMethod()"
 ...
 * @build nsk.jdi.VirtualMachine.redefineClasses.redefineclasses013
 *        nsk.jdi.VirtualMachine.redefineClasses.redefineclasses013a
 *
