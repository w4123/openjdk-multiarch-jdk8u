 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/enable/enable001.
 ...
 *              if this is a StepRequest and the thread named in the request has died.
 *     The test checks up on if a value returned by the method EventRequest.isEnabled()
 *     matchs a value set up with the method EventRequest.enable(), that is, true.
 *     The cases to test include all sub-types of EventRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequest.enable.enable001;
 *     the debuggee program - nsk.jdi.EventRequest.enable.enable001a.
