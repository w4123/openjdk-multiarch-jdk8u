 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/deleteEventRequests/delevtreqs002.
 ...
 *      Parameters: eventRequests - the list of eventRequests to remove
 ...
 *         return a List containing no eventRequests deleted by the tested method.
 *     Testcases include all subclasses of EventRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.deleteEventRequests.delevtreqs002;
 *     the debuggee program - nsk.jdi.EventRequestManager.deleteEventRequests.delevtreqs002a.
