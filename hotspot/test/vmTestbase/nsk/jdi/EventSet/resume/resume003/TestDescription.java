 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/resume/resume003.
 ...
 *     The test checks up on three ModificationWatchpointEvent sets with suspendPolicy()
 *     NONE, EVENT_THREAD, and ALL.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.resume.resume003;
 *     the debuggee program - nsk.jdi.EventSet.resume.resume003a.
