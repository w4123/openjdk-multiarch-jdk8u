 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/isAbstract/isabstract002 test
 *         checks the isAbstract() method of ReferenceType interface
 ...
 *         isAbstract() method - the com.sun.jdi.ObjectCollectedException
 ...
 *           - isabstract002b class was moved in 'loadclass' subdirectory;
 *           - package name was added in isabstract002b class;
 *           - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *           - ClassUnloader seekes for isabstract002b class in
