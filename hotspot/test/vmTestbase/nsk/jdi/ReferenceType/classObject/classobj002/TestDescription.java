 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/classObject/classobj002 test
 ...
 *         classObject() method - the com.sun.jdi.ObjectCollectedException
 ...
 *           - classobj002b class was moved in 'loadclass' subdirectory;
 *           - package name was added in classobj002b class;
 *           - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *           - ClassUnloader seekes for classobj002b class in
 ...
 * @build nsk.jdi.ReferenceType.classObject.classobj002
