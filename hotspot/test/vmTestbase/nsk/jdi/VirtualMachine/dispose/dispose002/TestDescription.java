 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/dispose/dispose002.
 ...
 *     debuggee's tested thread is not suspended at a breakpoint set up before,
 *     hence, corresponding event request is cancelled.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.dispose.dispose002;
 *     the debuggee program - nsk.jdi.VirtualMachine.dispose.dispose002a.
