 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ModificationWatchpointEvent/_itself_/mwevent001.
 ...
 *        The number of ModificationWatchpointEvents received is equal to
 *        the number of ModificationWatchpointRequests set up by a debugger.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ModificationWatchpointEvent._itself_.mwevent001;
 *     the debuggee program - nsk.jdi.ModificationWatchpointEvent._itself_.mwevent001a.
