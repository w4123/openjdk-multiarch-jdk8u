 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Locatable/location/location006.
 ...
 *              For example, abstract and native Methods will return null when
 *              their location method is called.
 *     when it is applied to a native method.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Locatable.location.location006;
 *     the debuggee program - nsk.jdi.Locatable.location.location006a.
 ...
 * COMMENTS:
 * The test is corrected to comply with latest Merlin specification
 * which states that for a native method, a returned value is not the null.
 *
 * @library /vmTestbase
 *          /test/lib
