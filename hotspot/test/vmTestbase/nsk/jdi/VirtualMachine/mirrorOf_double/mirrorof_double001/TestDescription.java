 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/mirrorOf_double/mirrorof_double001.
 ...
 *     com.sun.jdi.VirtualMachine.mirrorOf(double value)
 *     complies with the following requirements for DoubleValue:
 *     public double value()
 *     Returns this DoubleValue as a double.
 *     Returns: the double mirrored by this object.
 ...
 *     A debugger program - nsk.jdi.VirtualMachine.mirrorOf_double.mirrorof_double001;
 *     a debuggee program - nsk.jdi.VirtualMachine.mirrorOf_double.mirrorof_double001a.
