 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/disable/disable001.
 ...
 *     matchs a value set up with the method EventRequest.disable(), that is, false.
 *     The cases to test include all sub-types of EventRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequest.disable.disable001;
 *     the debuggee program - nsk.jdi.EventRequest.disable.disable001a.
