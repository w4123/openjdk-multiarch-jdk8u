 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadReference/name/name001.
 ...
 *     The debugger program - nsk.jdi.ThreadReference.name.name001;
 *     the debuggee program - nsk.jdi.ThreadReference.name.name001a.
