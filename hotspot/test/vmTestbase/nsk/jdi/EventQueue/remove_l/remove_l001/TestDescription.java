 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventQueue/remove_l/remove_l001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that a VMDisconnectedException thrown by
 *     the JDI method com.sun.jdi.request.EventQueue.remove(long)
 *     will always be preceded by a VMDisconnectEvent when
 *     a debuggee part of the test normally exits.
 * COMMENTS
