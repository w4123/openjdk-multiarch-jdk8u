 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/disable/disable003.
 * VM Testbase keywords: [quick, jpda, jdi, redefine]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test checks up com.sun.jdi.EventRequest.disable() after
 ...
 *     BreakpointEvent, debugger redefines the second class B, tries to disable
 *     the set breakpoint and checks status of the BreakpointRequest to be
 *     disabled.
 * COMMENTS
