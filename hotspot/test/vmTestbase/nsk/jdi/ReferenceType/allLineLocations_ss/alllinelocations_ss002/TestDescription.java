 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/allLineLocations_ss/alllinelocations_ss002.
 ...
 *     number.
 *     Debugger part of it attempts to get all locations that map to the debuggee
