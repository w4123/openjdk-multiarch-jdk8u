 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/allFields/allfields003 test
 ...
 *         allFields() method - the com.sun.jdi.ObjectCollectedException
 ...
 *         - allfields003b class was moved in 'loadclass' subdirectory;
 *         - package name was added in allfields003b class;
 *         - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *         - ClassUnloader seekes for allfields003b class in
 ...
 * @build nsk.jdi.ReferenceType.allFields.allfields003
