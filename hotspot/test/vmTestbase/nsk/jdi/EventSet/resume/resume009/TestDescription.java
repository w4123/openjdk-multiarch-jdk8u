 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/resume/resume009.
 ...
 *     The test checks up on three ThreadDeathEvent sets with suspendPolicy()
 *     NONE, EVENT_THREAD, and ALL.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.resume.resume009;
 *     the debuggee program - nsk.jdi.EventSet.resume.resume009a.
