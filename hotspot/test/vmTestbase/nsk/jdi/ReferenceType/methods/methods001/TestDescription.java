 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/methods/methods001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/methods/methods001 test
 *         checks the methods() method of ReferenceType interface
 *         of the com.sun.jdi package :
 *        the ReferenceType.methods() method is checked for methods of
 ...
 *        methods should be included in Method list returned by the methods() method.
