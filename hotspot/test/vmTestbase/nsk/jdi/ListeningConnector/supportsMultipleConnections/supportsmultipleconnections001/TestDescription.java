 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ListeningConnector/supportsMultipleConnections/supportsmultipleconnections001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the implementation of an object of the type
 *     ListeningConnector.Argument
 *     The test checks whether VMM has ListeningConnector supporting
 *     multiple connections.
 *     If no such ListeningConnector, the test prints warning message;
