 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PrimitiveValue/charValue/charvalue001.
 ...
 *     (as if the primitive had been cast to a char, in the narrowing case).
 *     Returns: the value, converted to char
 *     The test works as follows:
 *     A debugger program - nsk.jdi.PrimitiveValue.charValue.charvalue001;
 *     a debuggee program - nsk.jdi.PrimitiveValue.charValue.charvalue001a.
