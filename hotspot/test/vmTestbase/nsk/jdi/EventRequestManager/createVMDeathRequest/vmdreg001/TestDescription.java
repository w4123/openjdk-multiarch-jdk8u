 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createVMDeathRequest/vmdreg001.
 ...
 *      The new request is added to the list managed by this EventRequestManager.
 *      Use EventRequest.enable() to activate this event request.
 *      Not all target virtual machines support this operation.
 *      Use VirtualMachine.canRequestVMDeathEvent() to determine
 ...
 *     The debugger program - nsk.jdi.EventRequestManager.createVMDeathRequest.vmdreg001;
 *     the debuggee program - nsk.jdi.EventRequestManager.createVMDeathRequest.vmdreg001a.
