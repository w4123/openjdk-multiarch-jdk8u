 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/equals/equals001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/equals/equals001 test
 *         checks the equals() method of ReferenceType interface
 ...
 *         instances for this class and compares these ReferenceType instances
 *         by equals() method - true is expected to be return.
 *         Then the test compares two ReferenceType instances for different
 *         debugee's classes - false is expected to be return.
 *         Also the test compares ReferenceType instance with Object instance
 *         - false is expected to be return.
 * COMMENTS
