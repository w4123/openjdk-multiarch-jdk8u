 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/sourceDebugExtension/srcdebugx001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the SourceDebugExtension class file
 *     attribute can be obtained by the JDI method
 *     ReferenceType.sourceDebugExtension(), otherwise the method
 *     should throw the AbsentInformationException
 * COMMENTS
 ...
 *
 * @comment make sure srcdebugx001t is compiled with full debug info
