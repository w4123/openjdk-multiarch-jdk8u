 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/mirrorOf_int/mirrorof_int001.
 ...
 *     com.sun.jdi.VirtualMachine.mirrorOf(int value)
 *     complies with the following requirements for IntegerValue:
 *     public int value()
 *     Returns this IntegerValue as an int.
 *     Returns: the int mirrored by this object.
 ...
 *     A debugger program - nsk.jdi.VirtualMachine.mirrorOf_int.mirrorof_int001;
 *     a debuggee program - nsk.jdi.VirtualMachine.mirrorOf_int.mirrorof_int001a.
