 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/CharType/_itself_/chartype001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the implementation of an object of the type
 *     CharType.
 *     The test checks that for a mirror of char value the casts
 *     from Type to CharType and from PrimitiveType to CharType
 *     don't throw ClassCastException.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.CharType._itself_.chartype001;
 *     the debuggee program - nsk.jdi.CharType._itself_.chartype001a.
