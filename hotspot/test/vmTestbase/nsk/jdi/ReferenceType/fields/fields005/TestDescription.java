 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/fields/fields005.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *        com.sun.jdi.ReferenceType.fields()
 *     properly returns an empty field list for arrays (ArrayType) and primitive
 *     classes.
 *     Debugger part of it attempts to get a list of fields declared in several
