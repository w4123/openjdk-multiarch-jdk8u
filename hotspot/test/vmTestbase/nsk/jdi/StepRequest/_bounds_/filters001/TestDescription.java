 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StepRequest/_bounds_/filters001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the methods
 *     com.sun.jdi.request.StepRequest.addInstanceFilter(ObjectReference)
 *     com.sun.jdi.request.StepRequest.addClassFilter(ReferenceType)
 *     com.sun.jdi.request.StepRequest.addClassFilter(String)
 *     com.sun.jdi.request.StepRequest.addClassExclusionFilter(String)
