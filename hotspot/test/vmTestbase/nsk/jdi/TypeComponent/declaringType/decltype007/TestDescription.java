 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/declaringType/decltype007.
 ...
 *     nsk/jdi/TypeComponent/declaringType/declType007 checks assertion:
 ...
 *     Debugger gets all methods from debuggee (MainClass), finds constructors and
 *     static initializers and then checks if declaringType() returns the same
 *     reference type.
 * COMMENTS
 *
 * @library /vmTestbase
