 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StackFrame/setValue/setvalue003.
 ...
 *     The debugger program - nsk.jdi.StackFrame.setValue.setvalue.003;
 *     the debuggee program - nsk.jdi.StackFrame.setValue.setvalue.003a.
 ...
 * @build nsk.jdi.StackFrame.setValue.setvalue003.setvalue003
 *        nsk.jdi.StackFrame.setValue.setvalue003.setvalue003a
 *
 * @comment make sure setvalue003a is compiled with full debug info
 ...
 * sets up a breakpoint, and                                            <BR>
 * after getting the thread2 suspended, checks up that                  <BR>
 * for LocalVariables locvar1 and locvar2 the following sequence        <BR>
 *       Value val1 = stackFrame.getValue(locvar1);     <BR>
 *       stackFrame.setValue(locvar2, val1);            <BR>
 *       Value val2 = stackFrame.getValue(locvar2);     <BR>
...
public class setvalue003 {
    ...
    private String testedClassName =
        "nsk.jdi.StackFrame.setValue.setvalue003.Threadsetvalue003a";
        ...
        pipe.println("newcheck");
            ...
            label1: {
                ...
                for (int i2 = 0; i2 < 5; i2++) {
                    try {
                        locvar1 = stackFrame.visibleVariableByName(names[i2][0]);
                        locvar2 = stackFrame.visibleVariableByName(names[i2][1]);
                        log2("      : tested type: " + locvar1.typeName());
                        ...
                        if (locvar1 != null && locvar2 != null) {
                            ...
                            log3("ERROR: locvar1 != null && locvar2 != null");
                            expresult = returnCode1;
                        }
                    } catch ( Exception e ) {
