 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/sourceName/sourcename004.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *        com.sun.jdi.ReferenceType.sourceName()
 *     properly throws AbsentInformationException - if the source name is
 *     not known.
 *     The test exercises the following assertion:
 *     "For arrays (ArrayType) and primitive classes, AbsentInformationException
 *     is always thrown".
 *     It works as follows. Debugger part attempts to get an identifying
 *     source name of reference types corresponding to several debuggee fields
 *     by calling the JDI method. These fields have types of different kinds:
