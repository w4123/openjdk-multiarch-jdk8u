 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/suspend/suspend001.
 ...
 *     individual threads are counted. Before a thread will run again,
 *     it must be resumed (through resume() or ThreadReference.resume())
 *     the same number of times it has been suspended.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.suspend.suspend001;
 *     the debuggee program - nsk.jdi.VirtualMachine.suspend.suspend001a.
 ...
 * COMMENTS:
 *     The test was modified due to fix for the bug:
 *     4623150 TEST_BUG: suspend001 test fails due to internal ping timeout
 *
 * @library /vmTestbase
 *          /test/lib
