 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/isEnabled/isenabled001.
 ...
 *     matchs a value set up with the method EventRequest.setEnabled().
 *     The cases to test include all sub-types of EventRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequest.isEnabled.isenabled001;
 *     the debuggee program - nsk.jdi.EventRequest.isEnabled.isenabled001a.
