 ...
 * @run main/othervm -XX:-BackgroundCompilation -XX:CompileCommand=dontinline,TestStackBangMonitorOwned::m1 -XX:CompileCommand=exclude,TestStackBangMonitorOwned::m2 -Xss384K -XX:-UseOnStackReplacement TestStackBangMonitorOwned
 *
 */
