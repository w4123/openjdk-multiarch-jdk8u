 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/FloatType/_itself_/floattype001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the implementation of an object of the type
 *     FloatType.
 *     The test checks that for a mirror of float value, the casts
 *     from Type to FloatType and from PrimitiveType to FloatType
 *     don't throw ClassCastException.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.FloatType._itself_.floattype001;
 *     the debuggee program - nsk.jdi.FloatType._itself_.floattype001a.
