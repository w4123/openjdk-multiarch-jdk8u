 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/BScenarios/hotswap/tc02x001.
 ...
 *     it doesn't hit breakpoint (see COMMENTS).
 * COMMENTS:
 *     In step 6 waiting breakpoint is wrong due to JVMDI Redefine
 *     Classes spec says:"...All breakpoints in the class are cleared."
 ...
 * @build nsk.jdi.BScenarios.hotswap.tc02x001
 *        nsk.jdi.BScenarios.hotswap.tc02x001a
 *
