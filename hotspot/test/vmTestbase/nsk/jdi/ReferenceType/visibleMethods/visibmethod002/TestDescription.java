 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/visibleMethods/visibmethod002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/visibleMethods/visibmethod002 test
 *         checks the visibleMethods() method of ReferenceType interface
 *         of the com.sun.jdi package for not prepared class:
 *        the checked class is loaded but is not prepared.
 *        The ReferenceType.visibleMethods() method is called for
 *        this class - ClassNotPreparedException should be thrown
 *        in this case.
 * COMMENTS
 ...
 * @build nsk.jdi.ReferenceType.visibleMethods.visibmethod002
 *        nsk.jdi.ReferenceType.visibleMethods.visibmethod002a
 *
