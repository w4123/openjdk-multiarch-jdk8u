 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PrimitiveValue/byteValue/bytevalue001.
 ...
 *     The value will be narrowed as necessary, and magnitude or
 *     precision information may be lost
 *     (as if the primitive had been cast to a byte).
 *     Returns: the value, converted to byte
 *     The test works as follows:
 *     A debugger program - nsk.jdi.PrimitiveValue.byteValue.bytevalue001;
 *     a debuggee program - nsk.jdi.PrimitiveValue.byteValue.bytevalue001a.
