 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadGroupReference/threadGroups/threadgroups001.
 ...
 *     Returns a List containing each ThreadGroupReference in this thread group.
 *     Only the thread groups in this immediate thread group
 *     (and not its subgroups) are returned.
 *     Returns: a List of ThreadGroupReference objects mirroring the threads
 *              from this thread group in the target VM.
 ...
 *     The debugger program - nsk.jdi.ThreadGroupReference.threadGroups.threadgroups001;
 *     the debuggee program - nsk.jdi.ThreadGroupReference.threadGroups.threadgroups001a.
