 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PrimitiveValue/intValue/intvalue001.
 ...
 *     (as if the primitive had been cast to an int, in the narrowing case).
 *     Returns: the value, converted to int
 *     The test works as follows:
 *     A debugger program - nsk.jdi.PrimitiveValue.intValue.intvalue001;
 *     a debuggee program - nsk.jdi.PrimitiveValue.intValue.intvalue001a.
