 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PrimitiveValue/floatValue/floatvalue001.
 ...
 *     as if the primitive had been cast to a float, in the narrowing case).
 *     Returns: the value, converted to float
 *     The test works as follows:
 *     A debugger program - nsk.jdi.PrimitiveValue.floatValue.floatvalue001;
