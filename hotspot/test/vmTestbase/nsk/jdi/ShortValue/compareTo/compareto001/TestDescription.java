 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ShortValue/compareTo/compareto001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *   The test for the compareTo(Object o) method of com.sun.jdi.ShortValue
 ...
 *    - if an argument is not of ShortValue type, then a ClassCastException is thrown.
 *   where 'x', 'y' and 'z' denote ShortValue object.
 *   The debugger program - nsk.jdi.ShortValue.compareto.compareto001;
 *   the debuggee program - nsk.jdi.ShortValue.compareto.compareto001a;
 *   The test works as follows:
 *   Using nsk.jdi.share classes, the debugger connects to the debuggee.
 *   Then the debugger gets a list of short fields of debuggee's object of
 *   compareto001aClassToCheck type. For every field a mirror of ShortValue type
