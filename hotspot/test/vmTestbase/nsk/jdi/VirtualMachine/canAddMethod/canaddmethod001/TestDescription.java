 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/canAddMethod/canaddmethod001.
 ...
 *      Determines if the target VM supports the addition of methods
 *      when performing class redefinition.
 *      Returns: true if the feature is supported, false otherwise.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.canAddMethod.canaddmethod001;
 *     the debuggee program - nsk.jdi.VirtualMachine.canAddMethod.canaddmethod001a.
