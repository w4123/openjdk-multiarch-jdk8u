 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LocalVariable/type/type001.
 ...
 *     For object variables, the appropriate ReferenceType is returned if
 ...
 *     when the type is one of primitive types and
 ...
 *     The debugger program - nsk.jdi.LocalVariable.type.type001;
 *     the debuggee program - nsk.jdi.LocalVariable.type.type001a.
 ...
 * @build nsk.jdi.LocalVariable.type.type001
 *        nsk.jdi.LocalVariable.type.type001a
 *
 * @comment make sure type001a is compiled with full debug info
