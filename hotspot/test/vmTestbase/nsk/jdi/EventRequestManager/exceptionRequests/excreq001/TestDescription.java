 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/exceptionRequests/excreq001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.exceptionRequests()
 *     properly returns all previously created ExceptionRequest objects
 *     when:
 ...
 *
 * @comment make sure excreq001a is compiled with full debug info
