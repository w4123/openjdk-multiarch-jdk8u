 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/allLineLocations/alllinelocations001.
 ...
 *     when a tested method is native or abstract and
 *     when no AbsentInformationException is expected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Method.allLineLocations.alllinelocations001;
 *     the debuggee program - nsk.jdi.Method.allLineLocations.alllinelocations001a.
 ...
 * @build nsk.jdi.Method.allLineLocations.alllinelocations001
 *        nsk.jdi.Method.allLineLocations.alllinelocations001a
 *
