 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createClassUnloadRequest/cureg001.
 ...
 *      Returns: the created ClassUnloadRequest
 *     The test checks up on the following assertions:
 *     - Creates a new disabled ClassUnloadRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.createClassUnloadRequest.cureg001;
 *     the debuggee program - nsk.jdi.EventRequestManager.createClassUnloadRequest.cureg001a.
