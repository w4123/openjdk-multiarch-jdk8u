 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/isInitialized/isinit002 test
 ...
 *         isInitialized() method - the com.sun.jdi.ObjectCollectedException
 ...
 *           - isinit002b class was moved in 'loadclass' subdirectory;
 *           - package name was added in isinit002b class;
 *           - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *           - ClassUnloader seekes for isinit002b class in
 ...
 * @build nsk.jdi.ReferenceType.isInitialized.isinit002
