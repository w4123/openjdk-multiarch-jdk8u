 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventQueue/remove/remove004.
 ...
 *     The test checks the assertion
 *         "Waits forever for the next available event."
 *     in the condition of a limited time for testing.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventQueue.remove.remove004;
 ...
 *      "-debugee.vmkeys=${test.vm.opts} ${test.java.opts} -Djava.library.path=${java.library.path} -Dtest.timeout.factor=${test.timeout.factor}"
 */
