 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ArrayType/componentType/componenttype001.
 ...
 *     For primitive arrays, an appropriate PrimitiveType is always returned.
 *     For object arrays, the appropriate ReferenceType is returned if
 *     it has been loaded through the enclosing type's class loader.
 *     Returns: the Type of the array's components.
 *     Throws: ClassNotLoadedException -
 ...
 *     when the type is one of the ReferenceType(s).
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ArrayType.componentType.componenttype001;
 *     the debuggee program - nsk.jdi.ArrayType.componentType.componenttype001a.
