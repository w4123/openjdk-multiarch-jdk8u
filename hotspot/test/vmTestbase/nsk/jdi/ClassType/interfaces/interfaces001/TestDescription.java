 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassType/interfaces/interfaces001.
 ...
 *     Only the interfaces that are declared with the "implements" keyword
 *     in this class are included.
 *     Returns: a List of InterfaceType objects each mirroring a direct interface
 *     this ClassType in the target VM.
 *     If none exist, returns a zero length List.
 *     Throws: ClassNotPreparedException -
 *                 if this class not yet been prepared.
 *             ObjectCollectedException -
 *                 if this class has been unloaded and garbage collected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ClassType.interfacesinterfaces001;
 *     the debuggee program - nsk.jdi.ClassType.interfaces.interfaces001a.
