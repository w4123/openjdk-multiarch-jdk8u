 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadGroupReference/name/name001.
 ...
 *     The debugger program - nsk.jdi.ThreadGroupReference.name.name001;
 *     the debuggee program - nsk.jdi.ThreadGroupReference.name.name001a.
