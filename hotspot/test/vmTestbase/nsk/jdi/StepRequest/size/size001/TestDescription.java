 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StepRequest/size/size001.
 ...
 *     The debugger program - nsk.jdi.StepRequest.size.size001;
 *     the debuggee program - nsk.jdi.StepRequest.size.size001a.
