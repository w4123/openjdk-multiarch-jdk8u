 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/BooleanType/_itself_/booleantype001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the implementation of an object of the type
 *     BooleanType.
 *     The test checks that for a mirror of boolean value the casts
 *     from Type to BooleanType and from PrimitiveType to BooleanType
 *     don't throw ClassCastException.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.BooleanType._itself_.booleantype001;
 *     the debuggee program - nsk.jdi.BooleanType._itself_.booleantype001a.
