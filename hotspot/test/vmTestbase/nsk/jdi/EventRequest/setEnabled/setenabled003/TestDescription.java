 ...
 *                                        the thread named in the request has died.
 *     The cases to test include three states of the thread named in the request:
 *     not started, running, dead.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequest.setEnabled.setenabled003;
 *     the debuggee program - nsk.jdi.EventRequest.setEnabled.setenabled003a.
