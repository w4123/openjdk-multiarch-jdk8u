 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadReference/forceEarlyReturn/forceEarlyReturn011.
 ...
 *         Debugger VM force debuggee VM start test thread which in it's run() method call in infinite loop
 *         methods which access only internal fields, this methods should be inlined, so thread always has
