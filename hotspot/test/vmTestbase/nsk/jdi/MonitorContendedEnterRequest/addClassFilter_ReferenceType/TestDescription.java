 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MonitorContendedEnterRequest/addClassFilter_ReferenceType.
 * VM Testbase keywords: [quick, jpda, jdi, feature_jdk6_jpda, vm6]
 * VM Testbase readme:
 * DESCRIPTION
 *         The test checks up that a result of the method com.sun.jdi.MonitorContendedEnterRequest.addClassFilter(ReferenceType referenceType)
