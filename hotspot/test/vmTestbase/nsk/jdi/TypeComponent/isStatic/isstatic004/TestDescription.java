 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/isStatic/isstatic004.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for isStatic() method of TypeComponent interface.
 *  The test checks if the method returns true for each enum
 *  constants declared in mirrored enum type.
 *  The test consists of a debugger program (isstatic004.java)
 *  and debuggee application (isstatic004a.java).
 *  Package name is nsk.jdi.TypeComponent.isStatic .
 ...
 *  the debugger finds fields of enum type declared in isstatic004a
 *  class. Then the debugger checks test assertion for every
 *  enum constants declared in mirrored enum types.
 * COMMENTS:
