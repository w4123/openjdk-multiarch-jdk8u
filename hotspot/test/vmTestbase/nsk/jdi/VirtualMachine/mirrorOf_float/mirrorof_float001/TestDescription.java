 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/mirrorOf_float/mirrorof_float001.
 ...
 *     com.sun.jdi.VirtualMachine.mirrorOf(float value)
 *     complies with the following requirements for FloatValue:
 *     public float value()
 *     Returns this FloatValue as a float.
 *     Returns: the float mirrored by this object.
 ...
 *     A debugger program - nsk.jdi.VirtualMachine.mirrorOf_float.mirrorof_float001;
 *     a debuggee program - nsk.jdi.VirtualMachine.mirrorOf_float.mirrorof_float001a.
