 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/allFields/allfields005.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *        com.sun.jdi.ReferenceType.allFields()
 *     properly returns an empty field list for arrays (ArrayType) and primitive
 *     classes.
 *     Debugger part of it attempts to get a list of all fields declared and
 *     inherited in several reference types corresponding to debuggee field
 *     values, which themselves are:
