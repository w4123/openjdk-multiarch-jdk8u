 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/fields/fields004.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/fields/fields004 test
 *         checks the fields() method of ReferenceType interface
 *         of the com.sun.jdi package for class without any declarated fields:
 *        the ReferenceType.fields() method is checked for
 *        debugee's class which extends super class and implements interface.
 *        The checked class does not contain any declarated fields
 *        but extended super class and implemented interface have
 *        declarated fields.
