 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LocalVariable/name/name001.
 ...
 *     The debugger program - nsk.jdi.LocalVariable.name.name001;
 *     the debuggee program - nsk.jdi.LocalVariable.name.name001a.
 ...
 *
 * @comment make sure name001a is compiled with full debug info
