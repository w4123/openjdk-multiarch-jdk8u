 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/waitingThreads/waitingthreads002.
 ...
 *        - An object with threads waiting to lock monitor in a synchronized statement.
