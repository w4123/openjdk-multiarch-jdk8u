 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Type/signature/signature001.
 ...
 *     when the type is one of primitive types.
 *     The test works as follows:
 *     A debugger program - nsk.jdi.Type.signature.signature001;
 *     a debuggee program - nsk.jdi.Type.signature.signature001a.
