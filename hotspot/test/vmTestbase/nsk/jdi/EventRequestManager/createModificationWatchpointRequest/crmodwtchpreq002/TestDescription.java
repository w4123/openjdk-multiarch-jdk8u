 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createModificationWatchpointRequest/crmodwtchpreq002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.createModificationWatchpointRequest()
 *     properly throws NullPointerException - if field is null.
 * COMMENTS
 *     To fix the bug 4509034,
 *     the check if
 *                  vm.canWatchFieldModification() == true
