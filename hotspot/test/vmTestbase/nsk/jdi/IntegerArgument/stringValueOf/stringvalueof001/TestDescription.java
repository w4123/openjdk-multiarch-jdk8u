 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/IntegerArgument/stringValueOf/stringvalueof001.
 ...
 *         int value i used as parameter in
 *         intArgument.setValue(intArgument.stringValueOf(i))
 *         must be equal to int value returned by intArgument.intValue()
