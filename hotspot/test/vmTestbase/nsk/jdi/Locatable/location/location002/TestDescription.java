 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Locatable/location/location002.
 ...
 *     in case of the method Locatable.location() is invoked on an abstract method.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Locatable.location.location002;
 *     the debuggee program - nsk.jdi.Locatable.location.location002a.
