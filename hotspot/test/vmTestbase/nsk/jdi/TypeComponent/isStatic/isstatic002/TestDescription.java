 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/isStatic/isstatic002.
 ...
 *     nsk/jdi/TypeComponent/isStatic/isstatic002 checks assertions:
 *     public boolean isStatic()
 *     1. Returns true if the method was declared static
 *     2. Returns false otherwise.
 *    Debugger gets each method from debuggee calling by name and then checks
 *    if isStatic() returns expected value.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
