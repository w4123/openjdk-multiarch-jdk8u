 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LaunchingConnector/launch/launch004.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test is debugger-like application. It starts
 *     debugee VM so that debugger/debugee connection be correctly
 *     established via connector com.sun.jdi.RawCommandLineLaunch
 *     and dt_shmem transport.
