 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadDeathRequest/addThreadFilter/addthreadfilter001.
 ...
 *     The test checks that the method restricts the events genereted by
 *     this request to those in a thread to filter which is not main.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ThreadDeathRequest.addThreadFilter.addthreadfilter001;
 *     the debuggee program - nsk.jdi.ThreadDeathRequest.addThreadFilter.addthreadfilter001a.
