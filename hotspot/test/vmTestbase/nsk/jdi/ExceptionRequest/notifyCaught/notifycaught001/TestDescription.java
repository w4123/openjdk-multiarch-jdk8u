 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ExceptionRequest/notifyCaught/notifycaught001.
 ...
 *      Returns: boolean true if caught exceptions will be reported, false otherwise.
 *     The test checks if a boolean value,
 *     an argument of the method EventRequestManager.createExceptionRequest(),
 *     is equal to one returned by the method ExceptionRequest.notifyCaught()
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ExceptionRequest.notifyCaught.notifycaught001;
 *     the debuggee program - nsk.jdi.ExceptionRequest.notifyCaught.notifycaught001a.
