 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/methods/methods003 test
 ...
 *         methods() method - the com.sun.jdi.ObjectCollectedException
 ...
 *         - methods003b class was moved in 'loadclass' subdirectory;
 *         - package name was added in methods003b class;
 *         - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *         - ClassUnloader seekes for methods003b class in
 ...
 * @build nsk.jdi.ReferenceType.methods.methods003
 *        nsk.jdi.ReferenceType.methods.methods003a
 *
