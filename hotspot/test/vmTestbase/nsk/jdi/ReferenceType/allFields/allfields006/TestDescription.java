 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/allFields/allfields006.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for allFields() method of ReferenceType interface.
 *  The test checks if the method returns all enum constants
 *  declared in mirrored enum type and all inherited fields
 *  regardless if they are ambigous or not.
 *  The test consists of a debugger program (allfields006.java)
 *  and debuggee application (allfields006a.java).
 *  Package name is nsk.jdi.ReferenceType.allFields .
 ...
 *  the debugger calls allFields() method for field f1
 *  of enum type declared in allfields006a class.
 *  The result list must include enum constant fields e1 and e2,
 *  and two inherited fields with same name i1.
 * COMMENTS:
