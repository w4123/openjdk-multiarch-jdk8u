 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/isInitialized/isinit003.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for isInitialized() method of ReferenceType interface.
 *  The test checks if the method returns true for any
 *  mirrored enum type
 *  The test consists of a debugger program (isinit003.java)
 *  and debuggee application (isinit003a.java).
 *  Package name is nsk.jdi.ReferenceType.isInitialized .
 ...
 *  the debugger calls isInitialized() method for each mirorred
 *  enum type. The test fails if the method returned false once
 *  or more.
 * COMMENTS:
