 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/StackFrame/getValues/getvalues001.
 ...
 *     public java.util.Map getValues(java.util.List variables)
 *     Returns the values of multiple local variables in this frame.
 *     Each variable must be valid for this frame's method and
 *     visible according to the rules described in visibleVariables().
 *     Parameters: variables - a list of LocalVariable objects to be accessed
 *     Returns: a map associating each LocalVariable with its Value
 *     Throws: java.lang.IllegalArgumentException -
 *             if any variable is either invalid for this frame's method or
 *             not visible.
 ...
 *     The debugger program - nsk.jdi.StackFrame.getValues.getvalues001;
 *     the debuggee program - nsk.jdi.StackFrame.getValues.getvalues001a.
 ...
 * @build nsk.jdi.StackFrame.getValues.getvalues001
 *        nsk.jdi.StackFrame.getValues.getvalues001a
 *
 * @comment make sure getvalues001a is compiled with full debug info
