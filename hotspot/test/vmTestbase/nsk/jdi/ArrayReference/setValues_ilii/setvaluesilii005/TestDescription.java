 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii005.
 ...
 *     nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii005 checks assertion:
 *     public void setValues(int index, List values, int srcIndex, int length)
 ...
 *     setValues(0, List, 1, List.size() + 1) is invoked to set all elements of
 *     sample array from index 0 to ArrayReference from index 1. Since
 *     srcIndex + length is beyond the end of this array, IndexOutOfBoundsException
 *     should be thrown.
 * COMMENTS
 *
 * @library /vmTestbase
