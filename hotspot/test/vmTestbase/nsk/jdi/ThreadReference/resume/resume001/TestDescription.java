 ...
 *     suspend() or through VirtualMachine.suspend(), invoking this method
 *     has no effect. Otherwise, the count of pending suspends on this thread
 *     is decremented. If it is decremented to 0,
 ...
 *     The debugger program - nsk.jdi.ThreadReference.resume.resume001;
 *     the debuggee program - nsk.jdi.ThreadReference.resume.resume001a.
