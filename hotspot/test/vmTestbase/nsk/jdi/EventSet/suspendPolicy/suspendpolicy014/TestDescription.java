 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/suspendPolicy/suspendpolicy014.
 ...
 *     The cases to check include event set containing two more VMDeathRequests
 *     with suspendPolicies SUSPEND_EVENT_THREAD and SUSPEND_NONE.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy014;
 *     the debuggee program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy014a.
