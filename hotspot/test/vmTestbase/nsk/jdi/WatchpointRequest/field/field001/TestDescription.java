 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/WatchpointRequest/field/field001.
 ...
 *     an argument of the method EventRequestManager.createAccessWatchpointRequest(Field),
 *     is equal to one returned by the method WatchpointRequest.field()
 *     The test works as follows:
 *     The debugger program - nsk.jdi.WatchpointRequest.field.field001;
 *     the debuggee program - nsk.jdi.WatchpointRequest.field.field001a.
