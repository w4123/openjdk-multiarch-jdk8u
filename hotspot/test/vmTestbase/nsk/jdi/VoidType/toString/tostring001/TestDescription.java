 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VoidType/toString/tostring001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  The test for public toString() method of an implementing class of
 *  com.sun.jdi.VoidType interface.
 ...
 *     a VoidType object of a debuggee's void type method.
 * COMMENTS:
 *  The test is aimed to increase jdi source code coverage and checks
 *  the code which was not yet covered by previous tests for VoidType
