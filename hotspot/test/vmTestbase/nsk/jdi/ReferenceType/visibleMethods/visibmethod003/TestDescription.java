 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/visibleMethods/visibmethod003 test
 ...
 *         visibleMethods() method - the com.sun.jdi.ObjectCollectedException
 ...
 *         - visibmethod003b class was moved in 'loadclass' subdirectory;
 *         - package name was added in visibmethod003b class;
 *         - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *         - ClassUnloader seekes for visibmethod003b class in
 ...
 * @build nsk.jdi.ReferenceType.visibleMethods.visibmethod003
