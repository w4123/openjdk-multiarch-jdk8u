 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/declaringType/decltype006.
 ...
 *     nsk/jdi/TypeComponent/declaringType/declType006 checks assertion:
 ...
 *     overrides all method; interfaces MainInter and OverridenInter that
 *     extends MainInter and overrides all method from it.
 *     Debugger gets each method from debuggee (OverridenClass and OverridenInter)
 *     calling by name and then checks if declaringType() returns reference
 *     type where all method were declared (OverridenClass and OverridenInter).
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
