 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VMDeathEvent/_itself_/vmdeath001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *    The test exercises com.sun.jdi.event.VMDeathEvent interface.
 *    The test checks the following assertions:
 *        - VMDeathEvent is received by debugger when target VM terminates,
 *        - VMDeathEvent is received without creating any EventRequest,
 *        - VMDeathEvent precedes VMDisconnectEvent.
 *    A debugger class - nsk.jdi.VMDeathEvent.thread.thread001  ;
 *    a debuggee class - nsk.jdi.VMDeathEvent.thread.thread001a .
 ...
 *    If the debugger receives VMDeathEvent, it checks all assertions
 *    of the test. Since debugee may has been terminated this time,
