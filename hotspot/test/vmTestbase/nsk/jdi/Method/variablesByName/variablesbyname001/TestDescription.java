 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/variablesByName/variablesbyname001.
 ...
 *     public java.util.List variablesByName(java.lang.String name)
 *                                throws AbsentInformationException
 *     Returns a list containing each LocalVariable of a given name in this method.
 *     Multiple variables can be returned if the same variable name is used
 *     in disjoint scopes within the method.
 *     Returns: the list of LocalVariable objects of the given name.
 *              If there are no matching local variables,
 ...
 *     The debugger program - nsk.jdi.Method.variablesByName.variablesbyname001;
 *     the debuggee program - nsk.jdi.Method.variablesByName.variablesbyname001a.
 ...
 * @build nsk.jdi.Method.variablesByName.variablesbyname001
 *        nsk.jdi.Method.variablesByName.variablesbyname001a
 *
 * @comment make sure variablesbyname001a is compiled with full debug info
