 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LocalVariable/isVisible/isvisible001.
 ...
 *     See StackFrame.visibleVariables() for
 *     a complete description variable visibility in this interface.
 *     Parameters: frame - the StackFrame querying visibility
 *     Returns: true if this variable is visible; false otherwise.
 ...
 *     The debugger program - nsk.jdi.LocalVariable.isVisible.isvisible001;
 *     the debuggee program - nsk.jdi.LocalVariable.isVisible.isvisible001a.
 ...
 * @build nsk.jdi.LocalVariable.isVisible.isvisible001
 *        nsk.jdi.LocalVariable.isVisible.isvisible001a
 *
 * @comment make sure isvisible001a is compiled with full debug info
