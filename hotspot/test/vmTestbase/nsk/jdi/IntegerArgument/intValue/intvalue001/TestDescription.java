 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/IntegerArgument/intValue/intvalue001.
 ...
 *     IntegerArgument.intValue()
 *     complies with the following requirements:
 *       "Returns the value of the argument as a int."
 *     when the value of the argument is set
 ...
 *         int value set with intArgument.setValue()
 *         must be equal to int value get with intArguemnt.intValue()
