 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/mirrorOf_byte/mirrorof_byte001.
 ...
 *     complies with the following requirements for ByteValue:
 *     public byte value()
 *     Returns this ByteValue as a byte.
 *     Returns: the byte mirrored by this object.
 ...
 *     false otherwise.
 *     public int hashCode()
 *     Returns the hash code value for this ByteValue.
 *     Returns: the integer hash code
 *     The test works as follows:
 *     A debugger program - nsk.jdi.VirtualMachine.mirrorOf_byte.mirrorof_byte001;
 *     a debuggee program - nsk.jdi.VirtualMachine.mirrorOf_byte.mirrorof_byte001a.
