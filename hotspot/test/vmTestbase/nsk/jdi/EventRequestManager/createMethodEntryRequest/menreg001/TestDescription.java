 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createMethodEntryRequest/menreg001.
 ...
 *      Returns: the created MethodEntryRequest
 *     The test checks up on the following assertions:
 *     - Creates a new disabled MethodEntryRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.createMethodEntryRequest.menreg001;
 *     the debuggee program - nsk.jdi.EventRequestManager.createMethodEntryRequest.menreg001a.
