 ...
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/name/name002 test
 ...
 *         name() method - the com.sun.jdi.ObjectCollectedException
 ...
 *           - name002b class was moved in 'loadclass' subdirectory;
 *           - package name was added in name002b class;
 *           - ${COMMON_CLASSES_LOCATION} instead of ${TESTDIR} in .cfg file;
 *           - ClassUnloader seekes for name002b class in
 ...
 * @build nsk.jdi.ReferenceType.name.name002
