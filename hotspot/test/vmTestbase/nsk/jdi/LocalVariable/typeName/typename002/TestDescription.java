 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/LocalVariable/typeName/typename002.
 ...
 *     when the declared type is one of ReferenceTypes and
 ...
 *     The debugger program - nsk.jdi.LocalVariable.typeName.typename002;
 *     the debuggee program - nsk.jdi.LocalVariable.typeName.typename002a.
 ...
 * @build nsk.jdi.LocalVariable.typeName.typename002
 *        nsk.jdi.LocalVariable.typeName.typename002a
 *
 * @comment make sure typename002a is compiled with full debug info
