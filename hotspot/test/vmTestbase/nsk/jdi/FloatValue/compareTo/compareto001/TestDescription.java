 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/FloatValue/compareTo/compareto001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *   The test for the compareTo(Object o) method of com.sun.jdi.FloatValue
 ...
 *    - if an argument is not of FloatValue type, then a ClassCastException is thrown.
 *   where 'x', 'y' and 'z' denote FloatValue object.
 *   The debugger program - nsk.jdi.FloatValue.compareto.compareto001;
 *   the debuggee program - nsk.jdi.FloatValue.compareto.compareto001a;
 *   The test works as follows:
 *   Using nsk.jdi.share classes, the debugger connects to the debuggee.
 *   Then the debugger gets a list of float fields of debuggee's object of
 *   compareto001aClassToCheck type. For every field a mirror of FloatValue type
