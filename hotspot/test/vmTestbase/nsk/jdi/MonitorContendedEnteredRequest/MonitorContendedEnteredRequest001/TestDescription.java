 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MonitorContendedEnteredRequest/MonitorContendedEnteredRequest001.
 * VM Testbase keywords: [jpda, jdi, feature_jdk6_jpda, vm6]
 * VM Testbase readme:
 * DESCRIPTION
 *         This is stress test for MonitorContendedEnteredRequest and MonitorContendedEnteredEvent, debugger force
 *         debuggee generate several thousands of MonitorContendedEnteredEvents and checks that all events was received and contains
 *         correct information.
 ...
 *         This test set eventsNumber to 250 and threadsNumber to 1, but because of framework design each requested event should
