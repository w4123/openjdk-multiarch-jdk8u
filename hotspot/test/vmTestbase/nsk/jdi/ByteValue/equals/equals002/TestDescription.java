 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ByteValue/equals/equals002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the method
 *     com.sun.jdi.ByteValue.equals(Object)
 ...
 *          Returns:
 *              true if the Object is a ByteValue and if applying "==" to the
