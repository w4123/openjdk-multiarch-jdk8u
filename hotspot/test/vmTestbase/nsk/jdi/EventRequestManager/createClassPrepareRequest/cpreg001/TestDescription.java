 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createClassPrepareRequest/cpreg001.
 ...
 *      Returns: the created ClassPrepareRequest
 *     The test checks up on the following assertions:
 *     - Creates a new disabled ClassPrepareRequest.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventRequestManager.createClassPrepareRequest.cpreg001;
 *     the debuggee program - nsk.jdi.EventRequestManager.createClassPrepareRequest.cpreg001a.
