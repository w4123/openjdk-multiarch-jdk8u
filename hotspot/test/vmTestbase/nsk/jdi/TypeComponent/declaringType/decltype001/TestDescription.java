 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/declaringType/decltype001.
 ...
 *     nsk/jdi/TypeComponent/declaringType/declType001 checks assertions:
 ...
 *     Debugger gets each field from debuggee (MainClass and MainInter) calling
 *     by name and then checks if method declaringType() returns the same
 *     reference type.
 * COMMENTS
 *
 * @library /vmTestbase
