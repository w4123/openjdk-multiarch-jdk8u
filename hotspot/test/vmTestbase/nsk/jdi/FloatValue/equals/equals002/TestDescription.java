 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/FloatValue/equals/equals002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the method
 *     com.sun.jdi.FloatValue.equals(Object)
 ...
 *      Returns:
 *          true if the Object is a FloatValue and if applying "==" to the two
 *          mirrored primitives would evaluate to true; false otherwise.
