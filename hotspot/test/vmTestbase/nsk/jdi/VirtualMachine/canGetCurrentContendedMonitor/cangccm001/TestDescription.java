 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/canGetCurrentContendedMonitor/cangccm001.
 ...
 *     Determines if the target VM supports the retrieval of the monitor for
 *     which a thread is currently waiting.
 *     Returns: true if the feature is supported, false otherwise.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.canGetCurrentContendedMonitor.cangccm001;
 *     the debuggee program - nsk.jdi.VirtualMachine.canGetCurrentContendedMonitor.cangccm001a.
