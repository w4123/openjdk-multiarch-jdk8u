 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachineManager/attachingConnectors/attaching001.
 ...
 *     Any of the returned objects can be used to attach to
 *     an existing target VM and create a VirtualMachine mirror for it.
 *     Returns: a list of AttachingConnector objects.
