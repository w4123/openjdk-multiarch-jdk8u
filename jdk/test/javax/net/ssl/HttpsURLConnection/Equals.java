 ...
 * @test
 * @bug 8055299
 * @ignore test fails because of JDK-8055299is not backported yet
 * @library /lib/testlibrary
 * @build jdk.testlibrary.SimpleSSLContext
 * @run main/othervm -Djavax.net.debug=ssl,handshake,record -Djdk.tls.client.protocols=TLSv1.2,TLSv1.3 Equals
 */
