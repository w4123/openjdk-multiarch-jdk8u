 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/exit/exit002.
 ...
 *     The test checks up that after call to VirtualMachine.exit(testedReturnCode),
 *     a thread death exception is not thrown and
 *     debuggee's exit code is equal to testedReturnCode.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.exit.exit002;
 *     the debuggee program - nsk.jdi.VirtualMachine.exit.exit002a.
