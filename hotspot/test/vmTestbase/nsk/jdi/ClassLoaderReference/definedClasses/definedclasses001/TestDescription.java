 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassLoaderReference/definedClasses/definedclasses001.
 ...
 *      The returned list will include reference types loaded at least to
 *      the point of preparation and types (like array) for which preparation is not defined.
 *      Returns:
 *          a List of ReferenceType objects mirroring types loaded by this class loader.
 *          The list has length 0 if no types have been defined by this classloader.
 *     The test checks up on the assertion:
 *         The list has length 0 if no types have been defined by this classloader.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ClassLoaderReference.definedClasses.definedclasses001;
 *     the debuggee program - nsk.jdi.ClassLoaderReference.definedClasses.definedclasses001a.
