 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/bytecodes/bytecodes001.
 ...
 *     Not all target VMs support this query.
 *     See VirtualMachine#canGetBytecodes to determine if
 *     the operation is supported.
 *     Returns: the array of bytecodes.
 *     Throws: java.lang.UnsupportedOperationException -
 *             if the target VM does not support the retrieval of bytecodes.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Method.bytecodes.bytecodes001;
 *     the debuggee program - nsk.jdi.Method.bytecodes.bytecodes001a.
