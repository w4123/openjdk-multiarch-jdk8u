 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PathSearchingVirtualMachine/classPath/classpath001.
 ...
 *      Returns: List of components of the classpath, each represented by a String.
 *     The test checks that a List returned by the method contains
 *     only String elements and each element is a substring of String
 *     returned by the method System.getProperty("java.class.path") .
 *     The test works as follows:
 *     The debugger program - nsk.jdi.PathSearchingVirtualMachine.classPath.classpath001;
 *     the debuggee program - nsk.jdi.PathSearchingVirtualMachine.classPath.classpath001a.
