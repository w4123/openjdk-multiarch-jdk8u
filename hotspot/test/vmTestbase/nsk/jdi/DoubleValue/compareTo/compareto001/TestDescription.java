 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/DoubleValue/compareTo/compareto001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *   The test for the compareTo(Object o) method of com.sun.jdi.DoubleValue
 ...
 *    - if an argument is not of DoubleValue type, then a ClassCastException is thrown.
 *   where 'x', 'y' and 'z' denote DoubleValue object.
 *   The debugger program - nsk.jdi.DoubleValue.compareto.compareto001;
 *   the debuggee program - nsk.jdi.DoubleValue.compareto.compareto001a;
 *   The test works as follows:
 *   Using nsk.jdi.share classes, the debugger connects to the debuggee.
 *   Then the debugger gets a list of double fields of debuggee's object of
 *   compareto001aClassToCheck type. For every field a mirror of DoubleValue type
