 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/isVarArgs/isvarargs001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for isVarArgs() method of Method interface.
 *  The test checks if the method returns true for any
 *  mirrored method which has varargs argument.
 *  The test consists of a debugger program (isvarargs001.java)
 *  and debuggee application (isvarargs001a.java).
 *  Package name is nsk.jdi.Method.isVarArgs .
 ...
 *  which have varargs argument and calls isVarArgs() method
 *  for each found method mirror. The test fails if false is
