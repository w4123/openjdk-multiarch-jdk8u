 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/WatchpointEvent/object/object001.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *    This test exercises
 *      com.sun.jdi.event.WatchpointEvent.object() method.
 *    The test checks the following assertion:
 *       method WatchpointEvent.object() returns
 *         correct ObjectReference for instance field and
 *         null for static field.
 *    A debugger class - nsk.jdi.WatchpointEvent.object.object001  ;
 *    a debuggee class - nsk.jdi.WatchpointEvent.object.object001a .
 ...
 *    time  specified by <waittime> parameter. Finally debugger shuts down debuggee
 *    by <QUIT> command.
