 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequest/setEnabled/setenabled002.
 ...
 *       - IllegalThreadStateException  - if this is a StepRequest, val is true, and
 *                                        the thread named in the request has died.
 ...
 *     The debugger program - nsk.jdi.EventRequest.setEnabled.setenabled002;
 *     the debuggee program - nsk.jdi.EventRequest.setEnabled.setenabled002a.
