 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/stepRequests/stepreq001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     This test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.stepRequests()
 *     properly returns all StepRequest objects when:
 *      - event requests are disabled;
 *      - event requests are enabled.
 *     A debuggee part of the test creates several dummy user
 *     and daemon threads with own names.
 * COMMENTS
