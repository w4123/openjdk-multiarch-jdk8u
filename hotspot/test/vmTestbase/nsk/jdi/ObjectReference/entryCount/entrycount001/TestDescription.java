 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/entryCount/entrycount001.
 ...
 *     by the current owning thread. See ThreadReference.ownedMonitors() for
 *     a definition of ownership.
 *     Not all target VMs support this operation.
 *     See VirtualMachine#canGetMonitorInfo to determine
 ...
 *     The debugger program - nsk.jdi.ObjectReference.entryCount.entrycount 00;
 *     the debuggee program - nsk.jdi.ObjectReference.entryCount.entrycount 00a.
