 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/MethodExitEvent/method/method001.
 ...
 *          method if this method is normally exited by some
 *          executing thread in debugged VM;
 *        - received MethodExitEvent has proper references to:
 *            method,
 *            debugged VM,
 *            executed thread,
 *            related MethodExitRequest.
 *        - MethodExitEvent is emitted after last executed code of the
 *          method.
 *    A debugger class - nsk.jdi.MethodExitEvent.method.method001  ;
 *    a debuggee class - nsk.jdi.MethodExitEvent.method.method001a .
 ...
 *    invokes <foo()> method. This method updates <flag> field of <method001a>
 *    class.
 ...
 *    breakpoint is received, MethodExitRequest becomes enabled. <EventHandler>
 *    checks all received MetodExitEvents until second breakpoint is reached
 *    and MethodExitRequest becomes disabled.
