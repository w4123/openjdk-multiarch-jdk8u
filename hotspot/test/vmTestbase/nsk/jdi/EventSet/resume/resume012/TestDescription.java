 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/resume/resume012.
 ...
 *     The test checks up on VMDeathEvent set with suspendPolicy() EVENT_THREAD.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.resume.resume012;
 *     the debuggee program - nsk.jdi.EventSet.resume.resume012a.
 ...
 * COMMENTS:
 *     nsk/jdi/EventSet/resume/resume012 fails intermittently on all platforms
 *     In case of this test when we force VMDeathEvent with suspend policy set to EVENT_THREAD
 *     eventSet.resume() produces an exception (com.sun.jdi.InternalException: Inconsistent suspend policy)
 *     while trying to resume some thread associated with this event. But VMDeathEvent doesn't have any
 *     associated thread.
 *
 * @library /vmTestbase
 *          /test/lib
