 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ThreadReference/isSuspended/issuspended001.
 ...
 *     Testing includes one level suspend()-resume()
 *     possible pairs of methods specified in
 *     ThreadReference, VirtualMachine, and EventSet interfaces,
 *     except for the pair VirtualMachine.suspend()-ThreadReference.resume().
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ThreadReference.isSuspended.issuspended001;
 *     the debuggee program - nsk.jdi.ThreadReference.isSuspended.issuspended001a.
