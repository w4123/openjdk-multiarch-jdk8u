 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ReferenceType/visibleFields/visibfield002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *         nsk/jdi/ReferenceType/visibleFields/visibfield002 test
 *         checks the visibleFields() method of ReferenceType interface
 *         of the com.sun.jdi package for not prepared class:
 *        the checked class is loaded but is not prepared.
 *        The ReferenceType.visibleFields() method is called for
 ...
 * @build nsk.jdi.ReferenceType.visibleFields.visibfield002
 *        nsk.jdi.ReferenceType.visibleFields.visibfield002a
 *
