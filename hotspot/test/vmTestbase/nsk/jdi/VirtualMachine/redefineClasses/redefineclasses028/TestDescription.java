 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/redefineClasses/redefineclasses028.
 ...
 *        "If the bytes do not represent a valid class, ClassFormatError
 *        will be thrown."
 ...
 *     This test reads redefineclasses028b class-file and corrupts it.
 *     Then tries to redefine the redefineclasses028b class using the
 *     corrupted byte-code.
