 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii002.
 ...
 *     nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii002 checks assertion:
 *     public void setValues(int index, List values, int srcIndex, int length)
 *     1. Replaces all components to the end of this array with other values. Array
 *        has components of primitive types only. Index and srcIndex are in array's
 *        bounds.
 *     Debuggee defines eight sample array fields. One for each primitive type.
 *     Also, it defines tested array fields. All arrays have 14 elements.
 ...
 *     ArrayReference types. For i field the method setValues(0, List, 0, -1) is
 *     invoked to set all elements of sample array from index 0 to ArrayReference
 *     from index 0.
