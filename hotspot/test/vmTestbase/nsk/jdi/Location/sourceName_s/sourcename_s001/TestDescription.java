 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Location/sourceName_s/sourcename_s001.
 ...
 *     com.sun.jdi.Location.sourceName(String)
 *     complies with its spec:
 *     public String sourceName(String stratum)
 *                   throws AbsentInformationException
 *     Gets an identifing name for the source corresponding to this location.
 *     Interpretation of this string is the responsibility of the source
 *     repository mechanism.
 *     Returned name is for the specified stratum
 *     (see the class comment for a description of strata).
 *     The returned string is the unqualified name of the source file for
 *     this Location. For example, java.lang.Thread would return "Thread.java".
 ...
 *     The debugger program - nsk.jdi.Location.sourceName_s.sourcename_s001;
 *     the debuggee program - nsk.jdi.Location.sourceName_s.sourcename_s001a.
 ...
 *
 * @comment make sure sourcename_s001a is compiled with full debug info
