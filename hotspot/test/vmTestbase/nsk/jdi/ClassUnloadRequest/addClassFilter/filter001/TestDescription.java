 ...
 *     The debugger program - nsk.jdi.ClassUnloadRequest.addClassFilter.filter001;
 *     the debuggee program - nsk.jdi.ClassUnloadRequest.addClassFilter.filter001a.
 ...
 *     Each event is checked class name, which generates this event, to do
 *     match to defined filter.
 *     When class name does not match to defined filter, the test fails and
 *     produces a corresponding error message(s).
