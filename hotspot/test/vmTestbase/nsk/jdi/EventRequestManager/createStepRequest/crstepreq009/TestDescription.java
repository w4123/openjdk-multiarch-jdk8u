 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createStepRequest/crstepreq009.
 ...
 *       A sizevalue of StepRequest.STEP_MIN will generate a step event each time the code
 *       index changes. It represents the smallest step size available and often maps to
 *       the instruction level....
 *       A depth value of StepRequest.STEP_OUT restricts step events to caller frames
 *       only.
 *   The debugger class - nsk.jdi.EventRequestManager.createStepRequest.crstepreq009;
 *   the debuggee class - nsk.jdi.EventRequestManager.createStepRequest.crstepreq009a;
 ...
 *      with STEP_MIN size and STEP_OUT depth, resumes the debuggee and
