 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/BreakpointRequest/location/location001.
 ...
 *      Returns: the Location where this breakpoint has been set.
 *     The test checks if a Location object,
 *     an argument of the method EventRequestManager.createBreakpointRequest(Location),
 *     is equal to one returned by the method BreakpointRequest.location()
 *     The test works as follows:
 *     The debugger program - nsk.jdi.BreakpointRequest.location.location001;
 *     the debuggee program - nsk.jdi.BreakpointRequest.location.location001a.
