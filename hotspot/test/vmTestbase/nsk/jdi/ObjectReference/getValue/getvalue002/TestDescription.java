 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/getValue/getvalue002.
 ...
 *     The cases for testing include static and instance fields of primitive types
 *     created in debuggee's second thread with the method ClassType.newInstance().
 *     No exception is expected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ObjectReference.getValue.getvalue002;
 *     the debuggee program - nsk.jdi.ObjectReference.getValue.getvalue002a.
 ...
 * @build nsk.jdi.ObjectReference.getValue.getvalue002
