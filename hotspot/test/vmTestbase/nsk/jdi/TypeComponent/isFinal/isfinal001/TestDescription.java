 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/isFinal/isfinal001.
 ...
 *     nsk/jdi/TypeComponent/isFinal/isfinal001 checks assertions:
 *     public boolean isFinal()
 *     1. Returns true if the field was declared final.
 *     2. Returns false otherwise.
 *    Debugger gets each field from debuggee calling by name and then checks
 *    if method isFinal() returns expected value.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
