 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/resume/resume005.
 ...
 *     The test checks up on three ExceptionEvent sets with suspendPolicy()
 *     NONE, EVENT_THREAD, and ALL.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.resume.resume005;
 *     the debuggee program - nsk.jdi.EventSet.resume.resume005a.
