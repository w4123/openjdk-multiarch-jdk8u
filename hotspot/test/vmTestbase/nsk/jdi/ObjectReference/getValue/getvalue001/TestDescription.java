 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/getValue/getvalue001.
 ...
 *     created in debuggee's second thread.
 *     No exception is expected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ObjectReference.getValue.getvalue001;
 *     the debuggee program - nsk.jdi.ObjectReference.getValue.getvalue001a.
 ...
 *     4955084 TEST_BUG: JDI test does not resume suspended thread
 *
 * @library /vmTestbase
 *          /test/lib
