 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/name/name002.
 ...
 *     nsk/jdi/TypeComponent/name/name002 checks assertion:
 *     public java.lang.String name()
 *     1. Returns method name for a method.
 *     Debugger gets each method from debuggee calling by name and then checks
 *     if name() returns the same name of the method.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
