 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/TypeComponent/isStatic/isstatic003.
 ...
 *     nsk/jdi/TypeComponent/isStatic/isstatic003 checks assertion:
 *     public boolean isStatic()
 *     1. method isStatic() is defined for constructors and static initializers
 *        and does not throw an Exception.
 *     Debugger gets all methods from debuggee, finds contructors and static
 *     initializers only and checks if isStatic() doesn't throw any Exception.
 * COMMENTS
 *
 * @library /vmTestbase
 *          /test/lib
