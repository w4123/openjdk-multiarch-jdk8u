 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/locationsOfLine/locationsofline001.
 ...
 *     The returned list will contain a location for each  disjoint range of code
 *     indices that have been assigned to the given line by the compiler and/or VM.
 *     Each returned location corresponds to the beginning of this range.
 ...
 *             if there is no executable code in this method associated with
 *             the given line.
 *     when a tested method is non-native, non-abstract and
 *     when neither InvalidLineNumberException
 *               no AbsentInformationException is expected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Method.locationsOfLine.locationsofline001;
 *     the debuggee program - nsk.jdi.Method.locationsOfLine.locationsofline001a.
 ...
 *     Nonetheless, the locationsofline002.cfg file contains the option
 ...
 * @build nsk.jdi.Method.locationsOfLine.locationsofline001
 *        nsk.jdi.Method.locationsOfLine.locationsofline001a
 *
 * @comment make sure locationsofline001a is compiled with full debug info
