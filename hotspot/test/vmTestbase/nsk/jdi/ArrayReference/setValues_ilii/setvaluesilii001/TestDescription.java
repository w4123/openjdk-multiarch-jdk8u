 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii001.
 ...
 *     nsk/jdi/ArrayReference/setValues_ilii/setvaluesilii001 checks assertion:
 *     public void setValues(int index, List values, int srcIndex, int length)
 *     1. Replaces a range of array components with other values. Array has
 *        components of primitive types only. Index and srcIndex are in array's
 *        bounds.
 ...
 *     setValues(0, List, 0, LENGTH - i) is invoked to set LENGTH - i elements of
 *     sample array from index 0 to ArrayReference from index 0.
