 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/canUseInstanceFilters/canusefilters001.
 ...
 *      Determines if the target VM supports filtering events by
 *      specific instance object. For example, see
 *      BreakpointRequest.addInstanceFilter(com.sun.jdi.ObjectReference).
 *      Returns: true if the feature is supported, false otherwise.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.VirtualMachine.canUseInstanceFilters.canusefilters001;
 *     the debuggee program - nsk.jdi.VirtualMachine.canUseInstanceFilters.canusefilters001a.
