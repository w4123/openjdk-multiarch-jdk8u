 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/suspendPolicy/suspendpolicy017.
 ...
 *     The cases to check include event set containing three more VMDeathRequests
 *     with suspendPoliy SUSPEND_ALL, SUSPEND_NONE, and SUSPEND_EVENT_THREAD.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy017;
 *     the debuggee program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy017a.
