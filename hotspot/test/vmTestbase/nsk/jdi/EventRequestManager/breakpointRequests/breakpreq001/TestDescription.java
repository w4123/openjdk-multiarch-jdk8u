 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/breakpointRequests/breakpreq001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.breakpointRequests()
 ...
 *
 * @comment make sure breakpreq001t is compiled with full debug info
