 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ByteValue/compareTo/compareto001.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *   The test for the compareTo(Object o) method of com.sun.jdi.ByteValue
 ...
 *    - if an argument is not of ByteValue type, then a ClassCastException is thrown.
 *   where 'x', 'y' and 'z' denote ByteValue object.
 *   The debugger program - nsk.jdi.ByteValue.compareto.compareto001;
 *   the debuggee program - nsk.jdi.ByteValue.compareto.compareto001a;
 *   The test works as follows:
 *   Using nsk.jdi.share classes, the debugger connects to the debuggee.
 *   Then the debugger gets a list of byte fields of debuggee's object of
 *   compareto001aClassToCheck type. For every field a mirror of ByteValue type
