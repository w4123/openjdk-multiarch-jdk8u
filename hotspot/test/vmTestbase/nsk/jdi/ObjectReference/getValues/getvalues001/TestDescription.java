 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ObjectReference/getValues/getvalues001.
 ...
 *     The Fields must be valid for this ObjectReference; that is,
 *     they must be from the mirrored object's class or a superclass of that class.
 *     Parameters: fields - a list of Field objects containing the requested values.
 ...
 *    when both classes contain class and instance fields of primitive types.
 *    IllegalArgumentException is not expected.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.ObjectReference.getValues.getvalues001;
 *     the debuggee program - nsk.jdi.ObjectReference.getValues.getvalues001a.
