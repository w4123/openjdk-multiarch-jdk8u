 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventRequestManager/createAccessWatchpointRequest/craccwtchpreq002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test checks that the JDI method
 *     com.sun.jdi.request.EventRequestManager.createAccessWatchpointRequest()
