 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/VirtualMachine/mirrorOf_string/mirrorof_string001.
 ...
 *     com.sun.jdi.VirtualMachine.mirrorOf(String value)
 *     complies with the following requirements:
 *     public java.lang.String value()
 *     Returns the StringReference as a String.
 *     The returned string is the equivalent of the mirrored string,
 *     but is an entity in the client VM and
 *     can be manipulated like any other string.
 *     Returns: the string value.
 *     Throws:
 *     ObjectCollectedException - if this object has been garbage collected.
 *    The test works as follows:
 *     A debugger program - nsk.jdi.VirtualMachine.mirrorOf_string.mirrorof_string001;
 *     a debuggee program - nsk.jdi.VirtualMachine.mirrorOf_string.mirrorof_string001a.
