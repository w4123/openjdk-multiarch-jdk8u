 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/EventSet/suspendPolicy/suspendpolicy010.
 ...
 *     The cases to check include event sets containing one thread
 *     with all possible combinations: NONE, THREAD, ALL
 *     The test works as follows:
 *     The debugger program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy010;
 *     the debuggee program - nsk.jdi.EventSet.suspendPolicy.suspendpolicy010a.
