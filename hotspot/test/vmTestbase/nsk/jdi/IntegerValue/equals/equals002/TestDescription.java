 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/IntegerValue/equals/equals002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the method
 *     com.sun.jdi.IntegerValue.equals(Object)
 ...
 *      Returns:
 *          true if the Object is an IntegerValue and if applying "==" to the
