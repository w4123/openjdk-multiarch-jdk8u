 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/ClassType/interfaces/interfaces002.
 * VM Testbase keywords: [quick, jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *  A test for interfaces() method of ClassType interface.
 *  The test checks if the method returns expected
 *  nsk.jdi.ClassType.interfaces.interfaces002i interface
 *  for any enum type which implements this interface
 *  The test consists of a debugger program (interfaces002.java)
 *  and debuggee application (interfaces002a.java).
 *  Package name is nsk.jdi.ClassType.interfaces .
 ...
 *  the debugger calls interfaces() method for each field
 *  of enum type declared in interfaces002a class.
 *  The test fails if the expected interface has not been
