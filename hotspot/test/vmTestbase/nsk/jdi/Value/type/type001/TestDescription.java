 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Value/type/type001.
 ...
 *     com.sun.jdi.Value()
 *     complies with its spec when Value objects represent
 *     objects of the PrimitiveType.
 *     Note: The spec is missed.
 *     The test works as follows:
 *     A debugger program - nsk.jdi.Value.type.type001;
 *     a debuggee program - nsk.jdi.Value.type.type001a.
