 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/Method/argumentTypeNames/argumenttypenames002.
 ...
 *     argument variables are unavailable due to absent debug information.
 *     Returns: a List of strings containing the return type name.
 *     when methods' arguments are of ReferenceTypes.
 *     The test works as follows:
 *     The debugger program - nsk.jdi.Method.argumentTypeNames.argumenttypenames002;
 *     the debuggee program - nsk.jdi.Method.argumentTypeNames.argumenttypenames002a.
