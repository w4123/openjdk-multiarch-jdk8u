 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/PrimitiveValue/shortValue/shortvalue001.
 ...
 *     The value will be narrowed or widened as necessary, and
 *     magnitude or precision information may be lost
 *     (as if the primitive had been cast to a short, in the narrowing case).
 *     Returns: the value, converted to short
 *     The test works as follows:
 *     A debugger program - nsk.jdi.PrimitiveValue.shortValue.shortvalue001;
 *     a debuggee program - nsk.jdi.PrimitiveValue.shortValue.shortvalue001a.
