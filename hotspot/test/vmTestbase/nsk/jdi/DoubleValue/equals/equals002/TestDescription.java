 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jdi/DoubleValue/equals/equals002.
 * VM Testbase keywords: [jpda, jdi]
 * VM Testbase readme:
 * DESCRIPTION:
 *     The test for the boundary value of the parameters.
 *     The test checks up that the method
 *     com.sun.jdi.DoubleValue.equals(Object)
 ...
 *      Returns:
 *          true if the Object is a DoubleValue and if applying "==" to the
